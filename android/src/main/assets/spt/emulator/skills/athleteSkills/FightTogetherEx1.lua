...
local FightTogetherEx1 = class(FightTogether, "FightTogetherEx1")
FightTogetherEx1.id = "G03_1"
FightTogetherEx1.alias = "众志成城"
...
function FightTogetherEx1:ctor(level)
    FightTogether.ctor(self, level)

    ...
    self.view:RegOnContinueBtnClick(function()
        ...
        self.view:coroutine(function ()
            ...
            if api.success(response) then
                ...
                luaevt.trig('SDK_PushUserOp', 'Create', playerInfoModel:GetID(), playerName == "" and "none" or playerName, playerInfoModel:GetLevel(), server.id, server.name, playerInfoModel:GetDiamond())

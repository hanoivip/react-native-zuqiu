...
local TimeLimitStageShopTaskItemView = class(unity.base)

function TimeLimitStageShopTaskItemView:ctor()
...
function TimeLimitStageShopTaskItemView:start()
...
function TimeLimitStageShopTaskItemView:SetButtonState(isOpen, canReceive)
...
function TimeLimitStageShopTaskItemView:InitView(timeLimitStageShopTaskModel, receiveCallBack)
...
function TimeLimitStageShopTaskItemView:OnClickBtn()
    local btnState = self.model:GetButtonState()
    if btnState == -2 then 
...
return TimeLimitStageShopTaskItemView

...
local PowerShootRewardItemView = class(unity.base)

function PowerShootRewardItemView:ctor()
...
function PowerShootRewardItemView:InitView(treasureData)
...
function PowerShootRewardItemView:SetAnimatorState(animatorStatus)
...
function PowerShootRewardItemView:HideItem()
    GameObjectHelper.FastSetActive(self.itemAreaTrans.gameObject, false)
end

function PowerShootRewardItemView:onDestroy()
...
return PowerShootRewardItemView

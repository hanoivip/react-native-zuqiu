...
local GrowthPlanScrollItemView = class(unity.base)

function GrowthPlanScrollItemView:ctor()
...
function GrowthPlanScrollItemView:start()
    self.rewardBtn:regOnButtonClick(function()
        self:OnRewardBtnClick()
    end)
end

function GrowthPlanScrollItemView:InitRewardButtonState(state)
...
function GrowthPlanScrollItemView:OnRewardBtnClick()
    if type(self.onRewardBtnClick) == "function" then
        self.onRewardBtnClick()
    end
end

function GrowthPlanScrollItemView:InitView(growthPlanModel, index, parentScrollRect)
...
function GrowthPlanScrollItemView:onDestroy()
end

return GrowthPlanScrollItemView
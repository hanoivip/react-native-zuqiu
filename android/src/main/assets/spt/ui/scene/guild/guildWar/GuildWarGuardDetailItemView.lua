...
local GuildWarGuardDetailItemView = class(unity.base)

function GuildWarGuardDetailItemView:ctor()
...
function GuildWarGuardDetailItemView:start()
...
function GuildWarGuardDetailItemView:InitView(itemModel, currMember)
...
function GuildWarGuardDetailItemView:onDestroy()
end

return GuildWarGuardDetailItemView

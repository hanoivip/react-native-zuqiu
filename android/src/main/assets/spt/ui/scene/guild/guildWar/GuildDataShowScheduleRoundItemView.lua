...
local GuildDataShowScheduleRoundItemView = class(unity.base)

function GuildDataShowScheduleRoundItemView:ctor()
...
function GuildDataShowScheduleRoundItemView:Init(data, myGid)
    ...
    self.capture.text = tostring(data.seizeCnt)
    self.resize.text = tostring(data.captureCnt)
...
return GuildDataShowScheduleRoundItemView
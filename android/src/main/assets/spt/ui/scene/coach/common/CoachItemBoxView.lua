...
local CoachItemBoxView = class(unity.base)

function CoachItemBoxView:ctor()
    -- 自己的rectTransform
...
function CoachItemBoxView:InitView(coachItemModel, isShowName, isShowNum, isShowAddNum, isShowDetail)
...
function CoachItemBoxView:start()
...
function CoachItemBoxView:BuildPage()
...
function CoachItemBoxView:ResetAddNumSize()

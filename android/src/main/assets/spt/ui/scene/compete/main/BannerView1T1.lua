...
local BannerView1T1 = class(BannerViewBase)

function BannerView1T1:ctor()
    BannerView1T1.super.ctor(self)
...
function BannerView1T1:InitView(bannerCollectionModel, typeIndex, index)
...
function BannerView1T1:InitCompeteSign(i, worldTournamentLevel)

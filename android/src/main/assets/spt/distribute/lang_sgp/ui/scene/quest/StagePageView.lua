...
function StagePageView:DetectIsOpenDoubleDrop()
...
function StagePageView:AdjustViewByConditions()
    ...
    if hasSpecialConditions then
        ...
        self.challengeTimesTipTrans.anchoredPosition = Vector2(-115, 150)
        self.challengeTimesTipText.fontSize = 14
        self.challengeNum.fontSize = 14
        self.strengthTipTrans.anchoredPosition = Vector2(150, 150)

...
local SettingsLanguageCtrl = require("ui.controllers.settings.SettingsLanguageCtrl")
...
function SettingsCtrl:InitView()
    ...
    self.settingsLanguageCtrl = SettingsLanguageCtrl.new(self.settingsView.languageSettingView, self.data)
    self.settingsView.onSetLangFlag = function() self.settingsLanguageCtrl:SetLangFlag() end
...
function SettingsCtrl:OnSetLangFlag(langId)
   dump(langId)
   self.settingsLangModel:ChangeLanguage(langId)
end
